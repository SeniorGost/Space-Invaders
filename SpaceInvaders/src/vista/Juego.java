...
//			this.setVisible(true);
	...
	private void pintarPantalla() {
		...
		repaint();
		System.out.println(aPintar.size() + ":" + i); //Esto es para el debungin. Muestra por consola un número enorme así que lo he comentado. Quizás es la razón por la que me va mal, tengo demasiadas cosas que pintar? -G
	}
