...
public class ArtilleriaJugador {
	...
	*/
	public void tick(int posX, boolean willShoot) {
		if (willShoot) {
			BalaJugador nuevaBala = new BalaJugador(posX, 2);
			// Cuando se implementen las entidades multipixel, cambiar el segundo parametro de la constructora por la altura de la nave.
